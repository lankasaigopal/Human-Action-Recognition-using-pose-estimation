...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default='./squat.mp4', help='Path to video file or image file or "webcam" for webcam feed')
    parser.add_argument('--mode', type=str, default='video', help='Mode: "video", "webcam", or "image"')
